...
/**
 Base class for all AnimeBoard views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the AnimeBoard view hierarchy (such as wrapped iOS UIViews) was touched.
