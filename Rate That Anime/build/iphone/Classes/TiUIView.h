...
/**
 Base class for all RateThatAnime views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the RateThatAnime view hierarchy (such as wrapped iOS UIViews) was touched.
