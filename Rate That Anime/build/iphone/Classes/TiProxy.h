...
//Rare exceptions to indicate a bug in the _ratethatanime code (Eg, function that a subclass should have implemented)
...
/**
 The base class for RateThatAnime proxies.
 */
