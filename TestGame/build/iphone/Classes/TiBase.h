...
// in simulator we redefine to format for TestGame Developer console
...
{\
	NSString * exceptionName = [@"org.testgame." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.testgame";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITestGameNativeItemNone = -1, 
	UITestGameNativeItemSpinner = -2,
	UITestGameNativeItemProgressBar = -3,
	
	UITestGameNativeItemSlider = -4,
	UITestGameNativeItemSwitch = -5,
	UITestGameNativeItemMultiButton = -6,
	UITestGameNativeItemSegmented = -7,
	
	UITestGameNativeItemTextView = -8,
	UITestGameNativeItemTextField = -9,
	UITestGameNativeItemSearchBar = -10,
	
	UITestGameNativeItemPicker = -11,
	UITestGameNativeItemDatePicker = -12,
	
	UITestGameNativeItemInfoLight = -13,
	UITestGameNativeItemInfoDark = -14,
	
	UITestGameNativeItemDisclosure = -15,
	
	UITestGameNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TestGame instances of
