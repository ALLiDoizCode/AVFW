...
//@interface TestGameObject : NSObject
//@end

@interface TestGameObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TestGameObject class]])
		{
			for (NSString *key in [[(TestGameObject*)o modules] allKeys])
			{
