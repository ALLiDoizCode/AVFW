...
/**
 The base class for all TestGame modules
 */
...
/**
 TestGame Platform calls this method on startup.
 */
-(void)startup;

/**
 TestGame Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 TestGame Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 TestGame Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 TestGame Platform calls this method on resume.
 @param sender The sender of the event.
 */
