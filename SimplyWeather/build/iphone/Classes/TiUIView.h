...
/**
 Base class for all SimplyWeather views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the SimplyWeather view hierarchy (such as wrapped iOS UIViews) was touched.
